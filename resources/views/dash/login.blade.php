          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form id="my-form" class="pt-3" action="{{ route("dash/CheckLogin") }}" method="post">
                    @csrf
                  ...
                  <div class="mt-3">
                    <input value="SIGN IN" type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">
...
{!! JsValidator::formRequest('App\Http\Requests\LoginRequest', '#my-form'); !!}
    <!-- endinject -->
  </body>
</html>